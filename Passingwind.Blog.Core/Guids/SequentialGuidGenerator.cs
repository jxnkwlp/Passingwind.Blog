...
namespace Passingwind.Blog.Guids
{
	...
	{
		public SequentialGuidType DefaultType { get; set; } = SequentialGuidType.SequentialAtEnd;

		public Guid Create(SequentialGuidType? guidType = null)
		{
			guidType = guidType ?? DefaultType;
