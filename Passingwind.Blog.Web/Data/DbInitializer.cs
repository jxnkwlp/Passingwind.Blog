...
namespace Passingwind.Blog.Data
{
	public class DbInitializer : ISingletonService
	{
		...
		private void AddSimpleData(BlogDbContext dbContext, User user)
		{
			...
			var post = new Post()
			{
				Title = "This blog website build by asp.net core and entity framework core.",
				Content = "## This blog website build by asp.net core and entity framework core.",
				IsDraft = false,
				CreationTime = DateTime.Now,
				EnableComment = true,
				Description = "his blog website build by asp.net core and entity framework core.",
				UserId = user.Id,
			};
