        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsShowInList = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WidgetDynamicContents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermission", x => new { x.RoleId, x.Key });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "WidgetDynamicContentProperty",
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Name = table.Column<string>(maxLength: 64, nullable: true),
                    ValueType = table.Column<string>(maxLength: 16, nullable: true),
                    IsArray = table.Column<bool>(nullable: false),
                    Value = table.Column<string>(nullable: true),
                    WidgetDynamicContentId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WidgetDynamicContentProperty", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WidgetDynamicContentProperty_WidgetDynamicContents_WidgetDy~",
                        column: x => x.WidgetDynamicContentId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(maxLength: 16, nullable: true),
